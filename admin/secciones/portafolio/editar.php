   ...
   <div class="card-body">
      ...
      <form action="" enctype="multipart/form-data" method="post">
         ...
         <div class="mb-3">
            ...
            <input readonly value="<?php echo $txtid; ?>" type="text" class="form-control" name="txtid" id="txtid" aria-describedby="helpId" placeholder="" />
         ...
         <div class="mb-3">
            ...
            <img width="60" src="../../../assets/img/portfolio/<?php echo $imagen; ?>" alt="">

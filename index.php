...
//selecionar registros de tbl_entradas
...
<body id="page-top">
    ...
    <header class="masthead">
        <div class="container">
            ...
            <a class="btn btn-primary btn-xl text-uppercase" href="<?php echo $lista_configuracion[3]['valor']; ?>"><?php echo $lista_configuracion[2]['valor']; ?></a>
        </div>
    </header>
    <!-- Services-->
    <section class="page-section" id="services">
        <div class="container">
            <div class="text-center">
                <h2 class="section-heading text-uppercase"><?php echo $lista_configuracion[4]['valor']; ?></h2>
                <h3 class="section-subheading text-muted"><?php echo $lista_configuracion[5]['valor']; ?></h3>
            </div>
    ...
    <section class="page-section bg-light" id="portfolio">
        <div class="container">
            <div class="text-center">
                <h2 class="section-heading text-uppercase"><?php echo $lista_configuracion[6]['valor']; ?></h2>
                <h3 class="section-subheading text-muted"><?php echo $lista_configuracion[7]['valor']; ?></h3>
            </div>
            <div class="row">
    ...
    <section class="page-section" id="about">
        <div class="container">
            <div class="text-center">
                <h2 class="section-heading text-uppercase"><?php echo $lista_configuracion[8]['valor']; ?></h2>
                <h3 class="section-subheading text-muted"><?php echo $lista_configuracion[9]['valor']; ?></h3>
            </div>
            <ul class="timeline">
                <?php
                $contador = 1;
    ...
    <section class="page-section" id="contact">
        <div class="container">
            <div class="text-center">
                <h2 class="section-heading text-uppercase"><?php echo $lista_configuracion[12]['valor']; ?></h2>
                <h3 class="section-subheading text-muted"><?php echo $lista_configuracion[13]['valor']; ?></h3>
                <h4 class="text-muted"><?php echo $lista_configuracion[14]['valor']; ?></h4>
            </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-4 my-3 my-lg-0">
                    <a class="btn btn-dark btn-social mx-2" href="<?php echo $lista_configuracion[14]['valor']; ?>" aria-label="Twitter"><i class="fab fa-twitter"></i></a>
                    <a class="btn btn-dark btn-social mx-2" href="<?php echo $lista_configuracion[15]['valor']; ?>" aria-label="Facebook"><i class="fab fa-facebook-f"></i></a>
                    <a class="btn btn-dark btn-social mx-2" href="<?php echo $lista_configuracion[16]['valor']; ?>" aria-label="LinkedIn"><i class="fab fa-linkedin-in"></i></a>
                </div>
